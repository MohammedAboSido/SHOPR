...
import { AllBrands, BgBrands, BrandIcon, BrandsDetails, BrandsDetailsDescription, BrandsDetailsTitle, BrandsIcon, BrandsWrapper } from './style';
            ...
            <Container>
                <BrandsWrapper>
                    <BrandsDetails>
                        ...
                        <BrandsDetailsDescription>At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atqu.</BrandsDetailsDescription>
                        <AllBrands>
